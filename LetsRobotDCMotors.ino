...
int fspeed= 200;                        /// The "full" speed the motors are allowed to run at normally.
int hspeed = 125;                       /// The "half" speed the motors will run at.
int bspeed = fspeed + 55;               /// The "boost" speed the motors will run at under special circumstances.
